...
def page3_hypothesis_body():
    ...
    st.success(
        ...
        f"The correlation study at Customer Exit Study supports that. As per study report "
    ...
    st.error(
        ...
        f"The correlation study doesn't support that. As per study report customers with lower salary tend to exit less. "
